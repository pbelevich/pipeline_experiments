...
from cuda_rpc2 import DistributedCUDARPCSequential, WorkerModule, layer_on_device, pipeline_on_devices
...
def run_worker(rank, world_size, args):
    ...
    if rank == 0:
        ...
        if rank == 1:
            ...
            options.set_device_map("worker3", {3:2})
        elif rank == 5:
            options.set_device_map("worker4", {4:3})
        elif rank == 6:
            options.set_device_map("worker5", {5:4})
